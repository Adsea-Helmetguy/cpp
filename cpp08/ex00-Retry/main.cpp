...
int	main(void)
{
	...
	//TEST (6)-std::vector fail to find-
	std::cout << "\n\n\n\n---------------------------------" << std::endl;
	std::cout << GREEN << "Test(6) purpose to fail!!" << RT << std::endl;
	{
		int arr[] = {'A', 'b', 'W', 'E', 'a'};
		std::vector<char> chars(arr, arr + sizeof(arr) / sizeof(arr[0]));
		int	valueToFind = -5;
	...
	//TEST (7)-it_easyfind (returning iterator instead of int)-
	std::cout << "\n\n\n\n---------------------------------" << std::endl;
	std::cout << GREEN << "Test(7) easyfind returns iterator " \
	...
	//TEST (8)-it_easyfind (with std::deque)-
	std::cout << "\n\n\n\n---------------------------------" << std::endl;
	std::cout << GREEN << "Test(8) Now With std::deque" << RT << std::endl;
	{
		int arr[] = {1, 2, 3, 4, -5, 6};
		std::deque<int> nums(arr, arr + sizeof(arr) / sizeof(arr[0]));
		int	valueToFind = 3;
	...
	//TEST (9)-it_easyfind (with std::list)-
	std::cout << "\n\n\n\n---------------------------------" << std::endl;
	std::cout << GREEN << "Test(8.5) Now With std::list" << RT << std::endl;
	{
		int arr[] = {1, 2, 3, 4, -5, 6};
		std::list<int> nums(arr, arr + sizeof(arr) / sizeof(arr[0]));
		int	valueToFind = 4;
